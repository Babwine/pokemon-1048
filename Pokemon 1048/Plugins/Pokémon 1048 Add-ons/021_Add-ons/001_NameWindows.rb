...
def pbMessageDisplay(msgwindow,message,letterbyletter=true,commandProc=nil)
  ...
  textchunks=[]
  controls=[]
  while text[/(?:\\([Xn][Nn]|[Dd][Xx][Nn]|[Xn][Nn][Aa]|[Xn][Nn][Bb]|[Xn][Nn][Cc]|f|ff|ts|cl|me|se|wt|wtnp|ch)\[([^\]]*)\]|\\(g|cn|pt|wd|wm|op|cl|wu|sh|\.|\||\!|\^))/i]
  ...
  loop do
    ...
    for i in 0...controls.length
      ...
      when "wt"     # Wait X/20 seconds
        ...
        msgwindow.waitcount += 1 # param.to_i*Graphics.frame_rate/20
