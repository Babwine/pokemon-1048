class Battle::Battler
  ...
  def pbEffectsAfterMove(user, targets, move, numHits)
    ...
    # Hope
    if (move.function_code.start_with?("DoesNothing") || user.lastMoveFailed) && user.canHeal? && user.effects[PBEffects::Hope]
      if (ally = user.allAllies.detect { |b| b.ability_id == :HOPE})
